...
- `POST /schedules/assign` - Assign Schedule
  ...
  _All error code could be found in the `EAssignToken` class within `AssignScheduleFeedback` class in the [Arbin cti Toolbox](https://github.com/shoufang-w-arbin/Arbin-Toolbox-Python/blob/main/arbintoolbox/src/arbincti/feedback/schedule_operation.py)_
